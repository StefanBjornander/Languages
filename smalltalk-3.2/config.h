...
/* The relative path from the program to the exec-prefix. Defined only for
...
#define LTDL_SYSSEARCHPATH "/lib64:/usr/lib64:/lib:/usr/lib:/usr/lib/x86_64-linux-gnu/libfakeroot:/usr/local/lib:/usr/local/lib/x86_64-linux-gnu:/lib/x86_64-linux-gnu:/usr/lib/x86_64-linux-gnu:/lib32:/usr/lib32"
...
/* The relative path from the program to the module path. Defined only for
   relocatable installs. */
#define MODULE_PATH "../lib/smalltalk"
...
#define PACKAGE_STRING "GNU Smalltalk 3.2"
...
/* The value given by libc to NSIG */
#define STDLIB_NSIG 65

/* Patch level version of GNU Smalltalk */
#define ST_EDIT_VERSION 0
